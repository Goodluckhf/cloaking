...
(function(G) {
    ...
    var buildDeliveryPopup = function(params) {
        ...
        if (params.zdorov == 1) {
            $html = $('<div class="zd_dostavka">' +
                '<img class="zd_dostavka_flag" src="/landing/brand-parfume/files/_blocks/notificators/img/zdorov/flags/' + params.geoKey + '.png" alt=""/>' +
                '<p class="text"></p>' +
            ...
            $html = $('<div class="zd_dostavka">' +
                '<img class="zd_dostavka_top" src="/landing/brand-parfume/files/_blocks/notificators/img/zdorov/zd_dostavka.png" alt=""/>' +
                '<img class="zd_dostavka_flag" src="/landing/brand-parfume/files/_blocks/notificators/img/zdorov/flags/' + params.geoKey + '.png" alt=""/>' +
                '<p class="text"></p></div>' +
    ...
    var buildVisitorsPanel = function(geoKey) {
        ...
        str =  {
            RU: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Посетителей сегодня: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> Сейчас на сайте: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Покупок сегодня: <span>' + ad1_notify.stat.sales + '</span>');
            },

            PL: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Dzisiejsze odwiedziny: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> Goście online: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Dzisiejsze zakupy: <span>' + ad1_notify.stat.sales + '</span>');
            },

            ES: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Los visitantes hoy: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> Ahora online: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Compras de hoy: <span>' + ad1_notify.stat.sales + '</span>');
            },

            PT: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Visitantes hoje: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> On-line: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Compras de Hoje: <span>' + ad1_notify.stat.sales + '</span>');
            },

            RO: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Vizualizări astăzi: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> Acum online: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Au cumpărat astăzi: <span>' + ad1_notify.stat.sales + '</span>');
            },

            DE: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Anzahl der Besucher heute: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> jetzt Online: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Bestellung heute: <span>' + ad1_notify.stat.sales + '</span>');
            },

            TR: function(){
                $html.find('.visitors-today').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/all.png" alt="" /></i> Bugünün ziyaretçi sayısı: <span>' + ad1_notify.stat.visitors + '</span>');
                $html.find('.visitors-now').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/now.png" alt="" /></i> Şimdi çevrimiçi olanlar: <span>' + ad1_notify.stat.online + '</span>');
                $html.find('.visitors-buy').html('<i class="vis-ico"><img src="/landing/brand-parfume/files/_blocks/notificators/img/buy.png" alt="" /></i> Bugün ürün alımları: <span>' + ad1_notify.stat.sales + '</span>');
            }
        };
    ...
    var buildFreezer = function(geoKey) {
        ...
        var str = {
            RU: function(){
                ...
                $html.find('.freezing-info--packages').html('Осталось <span class="packages-count lastpack">132</span> шт. <br>по старому курсу</div>' + '<a href="/landing/brand-parfume/#close" class="freezing-close"></a>');
            },

            PL: function(){
                $html.find('.freezing-info--title').html('ZAMROZILIŚMY CENY!');
                $html.find('.freezing-info--packages').html('Zostało <span class="packages-count lastpack">132</span> szt. <br>wg starego kursu</div>' + '<a href="/landing/brand-parfume/#close" class="freezing-close"></a>');
            },

            ES: function(){
                $html.find('.freezing-info--title').html('Hemos congelado los precios!');
                $html.find('.freezing-info--packages').html('Quedan <span class="packages-count lastpack">132</span> unidades <br>con el precio antiguo</div>' + '<a href="/landing/brand-parfume/#close" class="freezing-close"></a>');
            },

            PT: function(){
                $html.find('.freezing-info--title').html('Preço congelar!');
                $html.find('.freezing-info--packages').html('<span class="packages-count lastpack">132</span> peças restantes <br>com preço antigo</div>' + '<a href="/landing/brand-parfume/#close" class="freezing-close"></a>');
            },

            RO: function(){
                $html.find('.freezing-info--title').html('Noi am înghețat prețul!');
                $html.find('.freezing-info--packages').html('Au rămas <span class="packages-count lastpack">132</span> unități <br>după cursul vechi</div>' + '<a href="/landing/brand-parfume/#close" class="freezing-close"></a>');
            }
        };
